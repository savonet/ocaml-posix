...
let blkcnt : (module Signed) =
  mkSigned ~name:"blkcnt_t" ~size:blkcnt_t_size
...
let blksize : (module Signed) =
  mkSigned ~name:"blksize_t" ~size:blksize_t_size
...
let dev : (module Unsigned) =
  mkUnsigned ~name:"dev_t" ~size:dev_t_size
...
let gid : (module Unsigned) =
  mkUnsigned ~name:"gid_t" ~size:gid_t_size
...
let id : (module Unsigned) =
  mkUnsigned ~name:"id_t" ~size:id_t_size
...
let ino : (module Unsigned) =
  mkUnsigned ~name:"ino_t" ~size:ino_t_size
...
let mode : (module Unsigned) =
  mkUnsigned ~name:"mode_t" ~size:mode_t_size
...
let nlink : (module Unsigned) =
  mkUnsigned ~name:"nlink_t" ~size:nlink_t_size
...
let off : (module Signed) =
  mkSigned ~name:"off_t" ~size:off_t_size
...
let pid : (module Signed) =
  mkSigned ~name:"pid_t" ~size:pid_t_size
...
let size : (module Unsigned) =
  mkUnsigned ~name:"size_t" ~size:size_t_size
...
let ssize : (module Signed) =
  mkSigned ~name:"ssize_t" ~size:ssize_t_size
...
let uid : (module Unsigned) =
  mkUnsigned ~name:"uid_t" ~size:uid_t_size
